...
energy_values_real = p_myfunc_realEnergyValues(U_sym, size(energy_values, 2), size(energy_values, 1));
p_myfunc_evaluateLandscape(energy_values, energy_values_real, x1_grid, x2_grid);
